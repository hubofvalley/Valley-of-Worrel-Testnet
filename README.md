...
- Selectable pruned or archive application-state storage, plus optional direct `worrelld` or Cosmovisor-managed service using the Worrell `x/upgrade` module, with automatic binary downloads disabled and explicit verified upgrade staging.
